...
public class HeroServiceIntegrationTest {
    ...
    void shouldReturnListOfHeroes() {
        ...
        var expected = List.of(new HeroDto(1L, "A-Bomb", "Male", "yellow", "Human", "No Hair", 203, "Marvel Comics", "-", "good", 441, List.of("Movie", "Movie 2", "Movie 3")),
                new HeroDto(2L, "Abe Sapien", "Male", "blue", "Icthyo Sapien", "No Hair", 191, "Dark Horse Comics", "blue", "good", 65, List.of("Misha Movie 2")),
                new HeroDto(3L, "Abin Sur", "Male", "blue", "Ungaran", "No Hair", 185, "DC Comics", "red", "good", 90, null),
                new HeroDto(4L, "Alex Mercer", "Male", "-", "Human", "-", -99, "Wildstorm", "-", "bad", -99, List.of("Misha Movie 2")),
                new HeroDto(5L, "Angel Salvadore", "Female", "brown", "-", "Black", 163, "Marvel Comics", "-", "good", 54, null),
                new HeroDto(6L, "Amazo", "Male", "red", "Android", "-", 257, "DC Comics", "-", "bad", 173, List.of("Misha Movie 5")));
